		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#synccafidocumentapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccafidocumentapp-display": {
								"semanticObject": "synccafidocumentapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.fi.documentapp",
									"url": sap.ui.require.toUrl("sync/ca/fi/documentapp")
								}
							}
						}
					}
