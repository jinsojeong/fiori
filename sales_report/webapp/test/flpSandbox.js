		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "매출 조회",
									"targetURL": "#synccafisalesreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccafisalesreport-display": {
								"semanticObject": "synccafisalesreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.fi.salesreport",
									"url": sap.ui.require.toUrl("sync/ca/fi/salesreport")
								}
							}
						}
					}
