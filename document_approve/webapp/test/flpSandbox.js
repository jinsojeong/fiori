		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[FI] 임시전표 승인",
									"targetURL": "#synccafidocumentapprove-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccafidocumentapprove-display": {
								"semanticObject": "synccafidocumentapprove",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.fi.documentapprove",
									"url": sap.ui.require.toUrl("sync/ca/fi/documentapprove")
								}
							}
						}
					}
